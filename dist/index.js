...
/*!*******************************************!*\
  !*** ./src/browser/api/browser-action.ts ***!
  \*******************************************/
/*! exports provided: BrowserActionAPI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BrowserActionAPI", function() { return BrowserActionAPI; });
...
const getBrowserActionDefaults = extension => {
  ...
  if (typeof browser_action === 'object') {
    ...
    const iconPath = Object(_common__WEBPACK_IMPORTED_MODULE_2__["getIconPath"])(extension);
...
class BrowserActionAPI {
  ...
  activateContextMenu(details) {
    ...
    const optionsPageUrl = optionsPage ? Object(_common__WEBPACK_IMPORTED_MODULE_2__["getExtensionUrl"])(extension, optionsPage) : undefined;
    append({
      label: 'Options',
...
/*!*************************************!*\
  !*** ./src/browser/api/commands.ts ***!
  \*************************************/
/*! exports provided: CommandsAPI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CommandsAPI", function() { return CommandsAPI; });
/**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getExtensionManifest", function() { return getExtensionManifest; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getExtensionUrl", function() { return getExtensionUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resolveExtensionPath", function() { return resolveExtensionPath; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validateExtensionResource", function() { return validateExtensionResource; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ResizeType", function() { return ResizeType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "matchSize", function() { return matchSize; });
...
/*!******************************************!*\
  !*** ./src/browser/api/context-menus.ts ***!
  \******************************************/
/*! exports provided: ContextMenusAPI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContextMenusAPI", function() { return ContextMenusAPI; });
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! electron */ "electron");
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(electron__WEBPACK_IMPORTED_MODULE_0__);
...
const matchesConditions = (props, conditions) => {
  ...
  if (props.targetUrlPatterns && props.targetUrlPatterns.length > 0 && targetUrl) {
    if (!props.targetUrlPatterns.some(pattern => Object(_common__WEBPACK_IMPORTED_MODULE_1__["matchesPattern"])(pattern, targetUrl))) {
      return false;
    }
  }

  if (props.documentUrlPatterns && props.documentUrlPatterns.length > 0 && documentUrl) {
    if (!props.documentUrlPatterns.some(pattern => Object(_common__WEBPACK_IMPORTED_MODULE_1__["matchesPattern"])(pattern, documentUrl))) {
      return false;
    }
  }
...
class ContextMenusAPI {
  constructor(ctx) {
    ...
    this.buildMenuItem = opts => {
      ...
      let icon = opts.showIcon ? Object(_common__WEBPACK_IMPORTED_MODULE_1__["getIconImage"])(extension) : undefined;
...
/*!************************************!*\
  !*** ./src/browser/api/cookies.ts ***!
  \************************************/
/*! exports provided: CookiesAPI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CookiesAPI", function() { return CookiesAPI; });
var CookieStoreID;
...
/*!******************************************!*\
  !*** ./src/browser/api/notifications.ts ***!
  \******************************************/
/*! exports provided: NotificationsAPI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    this.create = async ({
      ...
      if (opts.iconUrl) {
        ...
        if (((_url = url) === null || _url === void 0 ? void 0 : _url.protocol) === 'data:') {
          ...
          icon = await Object(_common__WEBPACK_IMPORTED_MODULE_1__["validateExtensionResource"])(extension, opts.iconUrl);
        }
...
/*!************************************!*\
  !*** ./src/browser/api/runtime.ts ***!
  \************************************/
/*! exports provided: RuntimeAPI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RuntimeAPI", function() { return RuntimeAPI; });
...
class RuntimeAPI extends events__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"] {
  constructor(ctx) {
    ...
    this.openOptionsPage = async ({
      ...
      const manifest = Object(_common__WEBPACK_IMPORTED_MODULE_1__["getExtensionManifest"])(extension);
...
/*!*******************************************!*\
  !*** ./src/browser/api/web-navigation.ts ***!
  \*******************************************/
/*! exports provided: WebNavigationAPI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WebNavigationAPI", function() { return WebNavigationAPI; });
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! electron */ "electron");
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(electron__WEBPACK_IMPORTED_MODULE_0__);
...
/*!************************************!*\
  !*** ./src/browser/api/windows.ts ***!
  \************************************/
/*! exports provided: WindowsAPI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WindowsAPI", function() { return WindowsAPI; });
...
/*!******************************!*\
  !*** ./src/browser/index.ts ***!
  \******************************/
/*! exports provided: ElectronChromeExtensions, Extensions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ElectronChromeExtensions", function() { return ElectronChromeExtensions; });
...
class ElectronChromeExtensions extends events__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"] {
  ...
  constructor(opts) {
    ...
    this.modulePath = modulePath || path__WEBPACK_IMPORTED_MODULE_2___default.a.join(__dirname, '..');
    this.api = {
...
/*!******************************!*\
  !*** ./src/browser/popup.ts ***!
  \******************************/
/*! exports provided: PopupView */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PopupView", function() { return PopupView; });
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! electron */ "electron");
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(electron__WEBPACK_IMPORTED_MODULE_0__);
...
/*!*******************************!*\
  !*** ./src/browser/router.ts ***!
  \*******************************/
/*! exports provided: ExtensionRouter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExtensionRouter", function() { return ExtensionRouter; });
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! electron */ "electron");
/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(electron__WEBPACK_IMPORTED_MODULE_0__);
...
/*!******************************!*\
  !*** ./src/browser/store.ts ***!
  \******************************/
/*! exports provided: ExtensionStore */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ElectronChromeExtensions", function() { return _browser__WEBPACK_IMPORTED_MODULE_0__["ElectronChromeExtensions"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Extensions", function() { return _browser__WEBPACK_IMPORTED_MODULE_0__["Extensions"]; });
